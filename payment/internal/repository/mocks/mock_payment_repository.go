...
import (
	...
	model "github.com/mllbll/space-manufacture/payment/internal/model"
...
// PayOrder provides a mock function with given fields: ctx, message
func (_m *PaymentRepository) PayOrder(ctx context.Context, message model.PayOrderRequest) (model.PayOrderResponse, error) {
...
//   - ctx context.Context
//   - message model.PayOrderRequest
func (_e *PaymentRepository_Expecter) PayOrder(ctx interface{}, message interface{}) *PaymentRepository_PayOrder_Call {
	return &PaymentRepository_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, message)}
}

func (_c *PaymentRepository_PayOrder_Call) Run(run func(ctx context.Context, message model.PayOrderRequest)) *PaymentRepository_PayOrder_Call {
