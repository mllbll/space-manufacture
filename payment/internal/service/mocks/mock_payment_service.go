...
func (_m *PaymentService) PayOrder(ctx context.Context, message model.PayOrderRequest) (model.PayOrderResponse, error) {
...
func (_e *PaymentService_Expecter) PayOrder(ctx interface{}, message interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, message)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, message model.PayOrderRequest)) *PaymentService_PayOrder_Call {
