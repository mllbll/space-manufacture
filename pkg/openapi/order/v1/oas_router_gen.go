	...
	default:
		...
		case '/': // Prefix: "/api/v1/orders"
			...
			if len(elem) == 0 {
				switch r.Method {
				case "POST":
					s.handleAddNewOrderRequest([0]string{}, elemIsEscaped, w, r)
				default:
	...
	default:
		...
		case '/': // Prefix: "/api/v1/orders"
			...
			if len(elem) == 0 {
				switch method {
				case "POST":
					r.name = AddNewOrderOperation
					r.summary = "Add new order"
					r.operationID = "AddNewOrder"
