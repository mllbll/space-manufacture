...
func (o OptOrderPaymentMethod) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	e.Int(int(o.Value))
...
func (o *OptOrderPaymentMethod) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptOrderPaymentMethod to nil")
	}
	o.Set = true
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptOrderPaymentMethod) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
