...
type Value struct {
	...
	//	*Value_DoubleValue
	//	*Value_BoolValue
	Types         isValue_Types `protobuf_oneof:"types"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Value) GetTypes() isValue_Types {
	if x != nil {
		return x.Types
	}
	return nil
...
func (x *Value) GetStringValue() string {
	if x != nil {
		if x, ok := x.Types.(*Value_StringValue); ok {
...
func (x *Value) GetInt64Value() int64 {
	if x != nil {
		if x, ok := x.Types.(*Value_Int64Value); ok {
			return x.Int64Value
		}
	}
	return 0
...
func (x *Value) GetDoubleValue() float64 {
	if x != nil {
		if x, ok := x.Types.(*Value_DoubleValue); ok {
...
func (x *Value) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Types.(*Value_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
func (*Value_StringValue) isValue_Types() {}

func (*Value_Int64Value) isValue_Types() {}

func (*Value_DoubleValue) isValue_Types() {}

func (*Value_BoolValue) isValue_Types() {}
...
type PartsFilter struct {
	...
	ManufacturerContries []string `protobuf:"bytes,4,rep,name=manufacturer_contries,json=manufacturerContries,proto3" json:"manufacturer_contries,omitempty"`
...
func (x *PartsFilter) GetManufacturerContries() []string {
	if x != nil {
		return x.ManufacturerContries
	}
	return nil
}
...
type GetPartResponse struct {
	...
	Parts         *Part `protobuf:"bytes,1,opt,name=parts,proto3" json:"parts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetPartResponse) GetParts() *Part {
	if x != nil {
		return x.Parts
	}
	return nil
...
// GetListPartsRequest запрос на получение списка деталей с возможностью фильтрации
...
// GetListPartsResponse ответ со списком найденных деталей
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"categories\x123\n" +
	"\x15manufacturer_contries\x18\x04 \x03(\tR\x14manufacturerContries\x12\x12\n" +
	"\x04tags\x18\x05 \x03(\tR\x04tags\"$\n" +
	"\x0eGetPartRequest\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\";\n" +
	"\x0fGetPartResponse\x12(\n" +
	"\x05parts\x18\x01 \x01(\v2\x12.inventory.v1.PartR\x05parts\"H\n" +
	...
	"\fGetListParts\x12!.inventory.v1.GetListPartsRequest\x1a\".inventory.v1.GetListPartsResponseBPZNgithub.com/mllbll/space_manufacture/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	1,  // 7: inventory.v1.GetPartResponse.parts:type_name -> inventory.v1.Part
	5,  // 8: inventory.v1.GetListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
	1,  // 9: inventory.v1.GetListPartsResponse.parts:type_name -> inventory.v1.Part
	...
	8,  // 12: inventory.v1.InventoryService.GetListParts:input_type -> inventory.v1.GetListPartsRequest
	7,  // 13: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	9,  // 14: inventory.v1.InventoryService.GetListParts:output_type -> inventory.v1.GetListPartsResponse
